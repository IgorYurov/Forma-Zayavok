...
namespace yt_DesignUI
{
    ...
    public class EgoldsGoogleTextBox : Control
    {
        ...
        //public Color BorderColorMine { get; set; } = FlatColors.Blue;
        ...
        private void AdjustTextBoxInput()
        {
            ...
            int offset = TextRenderer.MeasureText(TextPreview, FontTextPreview).Height / 3;
